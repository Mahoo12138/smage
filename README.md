...
A public instance is hosted at [Vercel](https://vercel.com) and can be accessed at [smage.mahoo12138.cn](https://smage.mahoo12138.cn). You can start using it immediately by entering your specific S3 settings under the Settings tab.
...
For obtaining S3 related keys, please refer to the documentation of your storage service provider. If you are using Cloudflare R2 Storage, you can check out the [Step-By-Step Guide for Cloudflare R2](https://docs.smage.mahoo12138.cn/guide/for-cloudflare-r2).
